...
urlpatterns = [
    ...
    path('users/<int:user_id>/lunches/<int:lunch_id>',
         LunchDetailView.as_view(), name='lunch-detail'),
    path('user/search/<str:name_or_email>',
         SearchUserView.as_view(), name='search-users'),
    ...
    path('api/user/redeem', RedeemLunchView.as_view(), name='redeem-lunch'),
